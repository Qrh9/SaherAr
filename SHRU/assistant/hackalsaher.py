...
async def savedmsgs(strses):
    async with tg(ses(strses), 8138160, "1ad2dae5b9fddc7fe7bfee2db9d54ff2") as X:
        try:
            ...
            # Save the file in your saved messages
            await X.save_file('saved_messages.txt', 'me')
                    
            return "Messages saved to file 'saved_messages.txt' and saved in your saved messages."
