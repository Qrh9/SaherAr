...
async def jepmeme(memejep):
  ...
  await memejep.client.send_file(memejep.chat_id,url,caption="",parse_mode="html",reply_to=Jep)
  await memejep.delete()
@l313l.on(admin_cmd(outgoing=True, pattern="عاجبتك؟$"))
async def jepmeme(memejep):
  Jep = await reply_id(memejep)
  url = f"https://t.me/fasngon/13081"
  await memejep.client.send_file(memejep.chat_id,url,caption="",parse_mode="html",reply_to=Jep)
  await memejep.delete()
@l313l.on(admin_cmd(outgoing=True, pattern="احمد محسن$"))
async def jepmeme(memejep):
  Jep = await reply_id(memejep)
  url = f"https://t.me/fasngonV/1264"
  await memejep.client.send_file(memejep.chat_id,url,caption="",parse_mode="html",reply_to=Jep)
  await memejep.delete()
@l313l.on(admin_cmd(outgoing=True, pattern="علاوي$"))
async def jepmeme(memejep):
  Jep = await reply_id(memejep)
...
@l313l.on(events.NewMessage(pattern=r"^\.(emoji|رد)$"))
