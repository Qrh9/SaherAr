...
async def list_commands(event):
    ...
    message = (
        ...
        "〈.يوزر2_ L〉 لـصـيـد يـوزر شبه ربـاعـي مـع اول حـرف مـن اخـتـيـارك بـدل L بالـحـرف الـمـطـلـوب\n"
        "〈.يوزر3〉  لـصـيـد يـوزر شـبـه ثـلاثـي\n"
        "〈يوزر3_L〉 لـصـيـد يـوزر شـبـه ثـلاثـي مـع اول حـرف مـن اخـتـيـارك بـدل L بالـحـرف الـمـطـلـوب\n"
        "𓇻ـــــــــــــــــــــــــــ※ــــــــــــــــــــــــــــــ𓇻\n"
        "⌔︙CH : @SXYO3"
    )
